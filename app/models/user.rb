class User < ActiveRecord::Base
	...
	validates :birth_year, numericality: {only_integer: true, message: "Enter numbers only"}, length: {minumum: 4, maximum: 4}
	validates :telephone, numericality: {only_integer: true, message: "Enter numbers only"}, length: {minumum: 10, maximum: 10} 
